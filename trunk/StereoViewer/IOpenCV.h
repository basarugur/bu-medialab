...
public:
    ...
    IOpenCV(CvSize _frame_size)
    {
        ...
        cvMoveWindow("MediaLab Demo", 0, 768);
        if (STEREO)
        {
        ...
        cvCreateTrackbar("Intensity Tol.", "MediaLab Demo", &int_tol, 90, on_trackbar);
...
//        cvCopy( frame, imageL, 0 );
        ...
        cvShowImage("MediaLab Demo", imageL);
