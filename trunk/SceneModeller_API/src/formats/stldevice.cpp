	...
	if (stream.is_open())
	{
		...
		while( !stream.eof() && currentString!="")
		{
			if (currentString == "facet")
			{
				...
				{
					newVertexa = currentObject->vertexList()[vertex_hash[hash_key.str()]];
				}
				else
				{
				...
				{
					newVertexb = currentObject->vertexList()[vertex_hash[hash_key1.str()]];
				}
				else
				{
				...
				{
					newVertexc = currentObject->vertexList()[vertex_hash[hash_key2.str()]];
				}
				else
				{
