#include "octree.h"
bool Octree::inside(const OctreeNode* node, const Triangle* triangle) const
{				
		float p0, p1, p2, R;
		float a0, a1, a2;
		Vector3 N, D, E0, E1, E2, A0(1,0,0), A1(0,1,0), A2(0,0,1);
		const Vector3 v1 = *triangle->a();
		const Vector3 v2 = *triangle->b();
		const Vector3 v3 = *triangle->c();
