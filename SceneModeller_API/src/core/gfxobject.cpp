...
void GfxObject::getCopy(GfxObject*& nwObj_)
{
		...
		trns_->rotation() = m_public_transform->rotation();
		trns_->scale() = m_public_transform->scale();
		trns_->translation() = m_public_transform->translation();
		...
		nwObj_->getIndividualTransform()->rotation() = m_individual_transform->rotation();
		nwObj_->getIndividualTransform()->scale() = m_individual_transform->scale();
		nwObj_->getIndividualTransform()->translation() = m_individual_transform->translation();
