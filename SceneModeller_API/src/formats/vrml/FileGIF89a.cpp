...
{
	if (image[n].localColorTable) {
		color[R_] = image[n].localColorTable[index][R_];
		color[G_] = image[n].localColorTable[index][G_];
		color[B_] = image[n].localColorTable[index][B_];
	}
	else if (globalColorTable) {
		color[R_] = globalColorTable[index][R_];
		color[G_] = globalColorTable[index][G_];
		color[B_] = globalColorTable[index][B_];
	}
}
